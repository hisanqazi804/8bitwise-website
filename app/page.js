            ...
            <AnimatedSection className="py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {SERVICES.slice(0, 3).map((service) => { // Showcasing first 3 services on homepage
            ...
            <AnimatedSection className="py-20 bg-gray-100 dark:bg-gray-900">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                             <Image src="https://placehold.co/600x450/3730a3/ffffff?text=Why+Us?" alt="A marketing team collaborating around a table with charts and laptops" width={600} height={450} className="rounded-lg shadow-2xl"/>
                        </div>
                        <div>
...
// Placeholder pages - In a real app, these would be built out.
const AboutUsPage = () => <div className="h-96 flex items-center justify-center"><h1 className="text-3xl">About Us Page</h1></div>;
const CaseStudiesPage = () => <div className="h-96 flex items-center justify-center"><h1 className="text-3xl">Case Studies Page</h1></div>;
const ContactUsPage = () => <div className="h-96 flex items-center justify-center"><h1 className="text-3xl">Contact Us Page</h1></div>;
